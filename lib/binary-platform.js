var impl = require("binary-platform");

exports.B_DECODE = function(bytes, offset, length, codec) {
    var newBytes = impl.B_TRANSCODE(bytes, offset, length, codec, "UTF-8");
...
exports.B_ENCODE = function(string, codec) {
    ...
    return impl.B_TRANSCODE(bytes, 0, impl.B_LENGTH(bytes), "UTF-8", codec);
}
